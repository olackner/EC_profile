...
export async function ec_data_get(ec_id, date_from, date_to) {
    ...
    const local_date_from = date_from || '2026-02-01';
    const local_date_to = date_to || '2026-02-01';
    ...
    return {
        ...
        t_prof_value: [
            ...
            },
            {
                ...
                dateto_offset: 0,
                timeto: "23:59:59",
                prof_values: "8.75, 8.75, 8.75, 8.75, 8, 8, 8, 8, 7.5, 7.5, 7.5, 7.5, 7, 7, 7, 7, 6.25, 6.25, 6.25, 6.25, 6.75, 6.75, 6.75, 6.75, 7.5, 7.5, 7.5, 7.5, 8, 8, 8, 8, 7.5, 7.5, 7.5, 7.5, 7.25, 7.25, 7.25, 7.25, 7, 7, 7, 7, 6.75, 6.75, 6.75, 6.75, 7, 7, 7, 7, 7.25, 7.25, 7.25, 7.25, 7.5, 7.5, 7.5, 7.5, 7.75, 7.75, 7.75, 7.75, 8, 8, 8, 8, 8.5, 8.5, 8.5, 8.5, 9, 9, 9, 9, 9.5, 9.5, 9.5, 9.5, 10, 10, 10, 10, 9.5, 9.5, 9.5, 9.5, 8.75, 8.75, 8.75, 8.75, 7.5, 7.5, 7.5, 7.5"
            }
        ]
    }
}   