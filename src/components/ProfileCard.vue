  ...
  <div class="dashboard-card p-8 mb-10">
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
      <div class="flex items-center gap-8">
        <div class="relative">
          <div 
            class="h-32 w-32 rounded-2xl bg-cover bg-center border border-border-light shadow-sm"
          ...
          ></div>
          <div class="absolute -bottom-2 -right-2 bg-leafy-green text-white px-3 py-1 rounded-full text-[11px] font-bold tracking-wide uppercase shadow-sm">
            Active
          </div>
        </div>
        <div>
          ...
          <div class="flex flex-wrap gap-y-2 gap-x-6 text-slate-500 text-sm font-medium">
            <span class="flex items-center gap-1.5"><span class="material-symbols-outlined text-base">calendar_month</span>since 08.03.2026</span>
            <span class="flex items-center gap-1.5"><span class="material-symbols-outlined text-base">input</span>12 Generation PoDs</span>            
            <span class="flex items-center gap-1.5"><span class="material-symbols-outlined text-base">output</span>36 Consumption PoDs</span>     
          </div>
        </div>
      </div>
